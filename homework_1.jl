...
student = (name = "Krabby Joe", kerberos_id = "krabb")
...
function create_bar()
	missing = zeros(100)
	halfway = length(missing) / 2
	foreach(x -> x += 1, missing[:, halfway - 10: halfway + 10])
	return missing
end
